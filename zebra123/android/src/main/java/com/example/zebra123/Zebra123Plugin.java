  ...
  private void connect(EventSink sink) {
    ...
    try {
      ...
      // datawedge supported?
        ...
        device.connect();
                Toast.makeText(context, " connecting ZebraDataWedge", Toast.LENGTH_LONG).show();
      ...
      // no supported device
        ...
        sendEvent(sink, ZebraDevice.Events.connectionStatus,map);
         ...
         Toast.makeText(context, "no supported device", Toast.LENGTH_LONG).show();
        ...
        sendEvent(sink, ZebraDevice.Events.error, ZebraDevice.toError("Error during connect()", e));
                 ...
                 Toast.makeText(context, "Error connecting to device", Toast.LENGTH_LONG).show();
