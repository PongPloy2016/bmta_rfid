                        ...
                        if (reader == null) {
                            ...
                            if (rfidReaders.size() > 0) {
                                ...
                                Log.e(Zebra123Plugin.getTagName(context),"No connectable rfid devices found");
                                        ...
                                        Toast.makeText(context, " No connectable rfid devices found", Toast.LENGTH_LONG).show();
        ...
        if (actionSource.equals(actionTarget)) {
            try {
                String barcode = intent.getStringExtra("com.symbol.datawedge.data_string");
                  ...
                  Log.e(Zebra123Plugin.getTagName(context), "barcode " + barcode.toString());
            ...
            if (reader != null)
            {
                if (mode == Modes.mixed || mode == Modes.rfid)
                {
                    Log.d(Zebra123Plugin.getTagName(context), "START SCANNNING");
                       ...
                       Toast.makeText(context, "START SCANNNING", Toast.LENGTH_LONG).show();
                ...
                if (mode == Modes.mixed || mode == Modes.barcode)
                {
                    ...
                    Toast.makeText(context, " START READING", Toast.LENGTH_LONG).show();
