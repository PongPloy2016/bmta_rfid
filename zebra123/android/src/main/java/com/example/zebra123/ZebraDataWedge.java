...
public class ZebraDataWedge extends BroadcastReceiver implements ZebraDevice {
    ...
    public void scan(Requests request) {
        ...
        Log.d(Zebra123Plugin.getTagName(context), "Sending scan request: " + request.toString());
        return;
    }
    ...
    public void setMode(Modes mode) {
        ...
        Log.d(Zebra123Plugin.getTagName(context), "Not implemented " + exception.toString());
        return;
    }
