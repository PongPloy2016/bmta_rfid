...
class TagRFIDLists extends StatefulWidget {
  const TagRFIDLists({super.key});

  @override
  State<TagRFIDLists> createState() => _TagRFIDListsState();
}

class _TagRFIDListsState extends State<TagRFIDLists> {
  Zebra123? zebra123;
