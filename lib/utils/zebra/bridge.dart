import 'package:bmta_rfid_app/utils/zebra/classes.dart' show Barcode, ConnectionStatus, RfidTag;
import 'package:bmta_rfid_app/utils/zebra/enums.dart' show Events, Interfaces, Modes, Requests, Status;
import 'package:bmta_rfid_app/utils/zebra/zebra123.dart' show Zebra123;
...
class Bridge {
  ...
  Bridge._() {
    ...
    _methodChannel = const MethodChannel("com.example.bmta_rfid_appX/methodX");

    // create event channel
    _eventChannel = const EventChannel("com.example.bmta_rfid_appX/eventX");
